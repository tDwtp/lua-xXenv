...
--[[-----------------------------------------------------------------------------
 A #table containing all commandline arguments for this script as strings.
 @field [parent = #global] #table argv
]]

--[[----------------------------------------------------------------------------
 Provides the DES-based functions.
 @field[parent = #global] des56#des56 des56 module [NOT PRELOADED]
 @usage require("des56")
 @usage local des56 = require("des56")
]]

--[[----------------------------------------------------------------------------
 This API is meant to provide a more complete programming environment for
 stand-alone Lua programs.
 @field[parent = #global] ex#ex ex module [NOT PRELOADED]
 @usage require("ex")
...
--[[----------------------------------------------------------------------------
 ...
 @field[parent = #global] bit#bit bit module [NOT PRELOADED]
 @usage require("bit")
...
--[[----------------------------------------------------------------------------
 ...
 @field[parent = #global] base64#base64 base64 module [NOT PRELOADED]
...
--[[----------------------------------------------------------------------------
 ...
 @field[parent = #global] luacurl#luacurl luacurl module [NOT PRELOADED]
...
--[[----------------------------------------------------------------------------
 ...
 @field[parent = #global] luasql#luasql luasql module [NOT PRELOADED]
...
--[[----------------------------------------------------------------------------
 ...
 @field[parent = #global] md5#md5 md5 module [NOT PRELOADED]
 @usage require("md5")
 @usage local md5 = require("md5")
]]

--[[----------------------------------------------------------------------------
 LuaSocket is a Lua extension library that provides support for the TCP and
 UDP transport layers, and a set of modules that add support for
 functionality commonly needed by applications that deal with the Internet.
 @field[parent = #global] socket#socket socket module [NOT PRELOADED]
 @usage require("socket")
 @usage local socket = require("socket")
]]

--[[----------------------------------------------------------------------------
 wxLua provides a interface for programming GUIs inside Lua.
 @field[parent = #global] wx#wx wx module [NOT PRELOADED]
]]
