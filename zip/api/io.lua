...
--[[-----------------------------------------------------------------------------
 ...
 Note that both @{#file.lock} and @{#file.unlock} extend the metatable for Lua file objects. <br />
 <br /> <b>_NOTE:_</b> this function is only usable if you required @{ex} first.
 @function [parent=#file] lock
 @param self
...
--[[-----------------------------------------------------------------------------
 Equivalent to @{#file.lock}("u", offset, length)
 Note that both to @{#file.lock} and @{#file.unlock} extend the metatable for Lua file objects.
 <br /> <b>_NOTE:_</b> this function is only usable if you required @{ex} first.
 @function [parent=#file] unlock
 @param self
 @param #number offset _(optional)_ offset in the file
 @param #number length _(optional)_ buffer length
]]
